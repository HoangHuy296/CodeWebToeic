  ...
  return (
    <div className="space-y-8">
      <PageHero
        ...
        title="Inbox cho hoc vien trao doi voi giang vien va admin."
        description="Hoc vien co the nhan notification, mo conversation, reply truc tiep va gui tin nhan moi cho admin hoac giang vien dang phu trach khoa hoc da enroll."
      />
